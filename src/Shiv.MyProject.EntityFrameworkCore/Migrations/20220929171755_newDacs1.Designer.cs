...
namespace Shiv.MyProject.Migrations
{
    ...
    [Migration("20220929171755_newDacs1")]
    partial class newDacs1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shiv.MyProject.EntityFrameworkCore.Country", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shiv.MyProject.EntityFrameworkCore.State", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Shiv.MyProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Shiv.MyProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Shiv.MyProject.EntityFrameworkCore.State", b =>
                {
                    b.HasOne("Shiv.MyProject.EntityFrameworkCore.Country", null)
                        .WithMany("cid")
